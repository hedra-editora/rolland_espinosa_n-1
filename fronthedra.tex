...
\mbox{\textbf{Romain Rolland} \hspace{0.6cm}\textbf{Romain Rolland} \hspace{0.6cm}\textbf{Romain Rolland}}\vspace*{-3pt}
\mbox{O clarão de \hspace{1.6cm}O clarão de \hspace{1.6cm}O clarão de}\vspace*{-3pt}
\mbox{Espinosa \hspace{2.08cm}Espinosa \hspace{2.08cm}Espinosa}\vspace*{-3pt}
}}
\end{changemargin}
%% Front ---------------------------------------------------------
% Titulo
